...
# 'Market Overview' 삭제 및 단일 메인 제목 적용
fig.suptitle(f'Korean Listed ETFs 3-Year Trend ({today_str})', fontsize=16, fontweight='bold', color=TEXT_COLOR, y=0.975)
...
# rect 상단 여백을 조율하여 제목과 첫 번째 그래프 간격 밀착
